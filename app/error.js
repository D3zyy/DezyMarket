...
export default function Error({ error }) {
    ...
    let result = error.message && error.message.startsWith("Nastala") 
        ? error.message 
        : "Nastala chyba.";
  ...
  return (
      ...
      <div className="p-4 text-center">
        ...
        >
         ...
         {result}
        <br />
       < Link  className="btn mt-3 " href={"/"}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
