...
<button disabled={accType?.priority > 1} onClick={openGiftSubModal} className="btn btn-sm">Darovat</button>
<button onClick={openGiftSubModal} className="btn btn-sm">Zrušit</button>
