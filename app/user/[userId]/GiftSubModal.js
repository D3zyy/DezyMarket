...
export function GiftSubModal({ idOfUser, allSub }) {
  ...
  const giftSubSend = async () => {
    setIsLoading(true); // Nastavení loading stavu na true
    try {
      ...
      setIsLoading(false); // Po dokončení nebo chybě, nastavíme loading na false
    }
  };
      ...
      <div className="modal-box flex flex-col items-center space-y-4">
        ...
        <div className="text-center mt-4">
          <button
            ...
            onClick={giftSubSend}
            disabled={isLoading} // Disable button během načítání
          >
            {isLoading ? "Načítání..." : "Darovat"} {/* Zobrazíme loading text, pokud je načítání */}
          </button>
