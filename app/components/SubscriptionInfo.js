    ...
    return (
        <>
            ...
            <div className="flex items-center space-x-2 mt-2">
                { formattedDate ?(scheduledToCancel ?  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                ...
                <button
                        className={`underline ${scheduledToCancel ? 'text-green-500' : 'text-red-500'}`}
                        >
