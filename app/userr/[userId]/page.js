...
console.log(userAcc.dateOfRegistration)
...
console.log(formatDateWithDotsWithTime(userAcc?.dateOfRegistration)); // Výstup: 18.01.2025 17:29:47.000
console.log(formatDateWithDotsWithoutTime(userAcc?.dateOfRegistration))
return (
  <>
